...
const departmentController = {
  ...
  createMember: async (req, res) => {
    try {
      ...
      const newMember = new DepartmentModel({
        code,
        name,
        description,
        isActive,
  ...
  getAllMembers: async (req, res) => {
    try {
      const members = await DepartmentModel.find();
  ...
  getMemberById: async (req, res) => {
    try {
      ...
      const member = await DepartmentModel.findById(staffId);
  ...
  updateMemberById: async (req, res) => {
    try {
      ...
      const updatedMember = await DepartmentModel.findByIdAndUpdate(
        staffId,
        updatedData,
        { new: true }
      );
  ...
  deleteMemberById: async (req, res) => {
    try {
      ...
      const deletedMember = await DepartmentModel.findByIdAndDelete(staffId);
